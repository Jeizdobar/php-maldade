        ...
        <?php while ($linha = $query->fetch_assoc()) { ?>
            <div class="post">
                ...
                <div class="options-post">
                    <p><?php echo "<a href='http://localhost/ua/login/admin/editarpost.php?id=" . $linha["id"] . "'>Editar</a>" ?></p>
                    <p><?php echo "<a href='http://localhost/ua/login/admin/excluirpost.php?id=" . $linha["id"] . "'>Excluir</a>" ?></p>
                </div>
                <?php echo '</a>'; ?>
            </div>
        <?php } ?>
